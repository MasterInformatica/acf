...
\begin{frame}
  ...
  \begin{itemize}
  \item \textbf{Handbook of modal logic}; Studies in logic and Practical
    reasoning. Volume 3. D.M GABBAT et al. Elsevier
  \item \textbf{Tableau Methods for Epistemic Modal Logics}; Maurice
    Ndashimye. African Institute for Mathematical Sciences (AIMS). 19 May
    2011.
  \item \textbf{Modal logic and its applications, explained using Puzzles
      and Examples}; Marek Perkowski. Department of Electrical and Computer
    Engineering. PSU. 4 March 2011
  \item \textbf{Modal logic. Epistemic Logic}; Eric Pacuit. University of
    Maryland, College Park; 19 April 2012.
  \end{itemize}
\end{frame}
%
%
